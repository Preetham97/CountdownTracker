...
- **Time-bucketed active items** — In a section's detail, active items are grouped into collapsible **Overdue**, **This Week**, **This Month**, and **Later** buckets. Overdue (red) and This Week expand by default; This Month and Later collapse so a section with dozens of countdowns stays scannable. Empty buckets hide their headers entirely.
